...
class BookingDetailsPageAtHome extends StatefulWidget {
  String booking_id = "";
  // String coupon = "";
  // String discount = "";

  BookingDetailsPageAtHome(
      {required this.booking_id,
        // required this.coupon,
        // required this.discount,
      });
  @override
  State<BookingDetailsPageAtHome> createState() => _BookingDetailsPageAtHomeState();
}

class _BookingDetailsPageAtHomeState extends State<BookingDetailsPageAtHome> {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text("${S.of(context).YourPaymentof} ₹ ${_getBookingDetailsModel!.bookingDetails!.amount.toString()} ${S.of(context).isSuccessful}",
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 20),
                                  child: Image.asset(ProjectImage.pay, height: 20, width: 25,),
                                ),
                                Text(_getBookingDetailsModel!.bookingDetails!.amount.toString(),
                                  style: GoogleFonts.poppins(
                                      fontSize: 15,
                                      color: Colors.black,
                                      fontWeight: FontWeight.w500),
