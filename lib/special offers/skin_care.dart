...
class _SkinCareState extends State<SkinCare> {
  ...
  final List<TopSalonModel> _topsalonlist = [
    TopSalonModel(image: ProjectImage.skincare, name: "Hair Salon"),
    TopSalonModel(image: ProjectImage.skincare, name: "Nail Salon"),
    TopSalonModel(image: ProjectImage.skincare, name: "Skin care"),
    TopSalonModel(image: ProjectImage.skincare, name: "Skin care"),
  ];
